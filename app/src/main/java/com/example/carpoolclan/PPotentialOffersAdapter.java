...
public class PPotentialOffersAdapter extends RecyclerView.Adapter<PotentialOffersViewHolder> {

    DDispatcherController dispatcherController;

    public PPotentialOffersAdapter(DDispatcherController dispatcherController) {
...
class PotentialOffersViewHolder extends RecyclerView.ViewHolder {
    ...
    private PPotentialOffersAdapter adapter;
    ...
    public PotentialOffersViewHolder linkAdapter(PPotentialOffersAdapter adapter) {
