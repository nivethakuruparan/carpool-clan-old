...
public class PotentialOffersAdapter extends RecyclerView.Adapter<PotentialOffersAdapter.ViewHolder> {
    ...
    ButtonClickListener buttonClickListener; // need to listen for a button click

    public PotentialOffersAdapter(List<PotentialOffersCard> offersCardList, ButtonClickListener buttonClickListener) {
